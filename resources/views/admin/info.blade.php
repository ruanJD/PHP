...
@section('content')
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                ...
                <li>
                    <label>版本</label><span>v-4.1</span>
                </li>
                <li>
                    <label>操作系统</label><span>{{php_uname('v')}}</span>
                </li>
                <li>
                    <label>上传附件限制</label><span>{{get_cfg_var ("upload_max_filesize")?get_cfg_var ("upload_max_filesize"):""}}</span>
                </li>
                <li>
    ...
    <div class="result_wrap">
        ...
        <div class="result_content">
            <ul>
                <li>
                    <label>官方交流网站：</label><span><a href="#">ruan</a></span>
                </li>
                <li>
